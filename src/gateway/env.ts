...
export function buildEnvVars(env: MoltbotEnv): Record<string, string> {
  ...
  if (env.GOOGLE_CHAT_SERVICE_ACCOUNT) envVars.GOOGLE_CHAT_SERVICE_ACCOUNT = env.GOOGLE_CHAT_SERVICE_ACCOUNT;
  if (env.GOOGLE_CHAT_AUDIENCE) envVars.GOOGLE_CHAT_AUDIENCE = env.GOOGLE_CHAT_AUDIENCE;
  if (env.GOOGLE_CHAT_AUDIENCE_TYPE) envVars.GOOGLE_CHAT_AUDIENCE_TYPE = env.GOOGLE_CHAT_AUDIENCE_TYPE;
